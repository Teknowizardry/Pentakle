...
static const int64 MAX_MONEY = 7339999999 * COIN; // Pentakle max transaction 7,339,999,999
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 160 / 250; // Pentakle: 160 blocks found a day. Priority cutoff is 100 pentakle day / 250 bytes.
    }
