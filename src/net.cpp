...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pentakle " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pentakle.tk", "pentakle.tk"},
//    {"pentaklepool.org", "dnsseed.pentaklepool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pentakle is probably already running."), addrBind.ToString().c_str());
        else
